          ...
          <div className="bento-card overflow-hidden relative" style={{
            ...
            <div className="px-4 md:px-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <a href="https://www.linkedin.com/in/shukla-ankit/" target="_blank" rel="noopener noreferrer"
                ...
                style={{ background: 'linear-gradient(135deg, #eff6ff, #dbeafe)', border: '1px solid rgba(37,99,235,0.18)', boxShadow: '0 2px 8px rgba(37,99,235,0.06)' }}>
                <div className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: '#0077b5' }}>
              ...
              <a href="https://github.com/ankitshukla6496" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-4 rounded-xl p-4 group transition-all"
                style={{ background: 'linear-gradient(135deg, #f8fafc, #f1f5f9)', border: '1px solid rgba(30,30,30,0.14)', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
              ...
              <a href="https://instagram.com/ankit.shukla.ig" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-4 rounded-xl p-4 group transition-all"
                style={{ background: 'linear-gradient(135deg, #fff1f2, #fdf2f8)', border: '1px solid rgba(225,29,72,0.18)', boxShadow: '0 2px 8px rgba(225,29,72,0.06)' }}>
