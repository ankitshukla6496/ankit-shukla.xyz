...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Ankit Shukla.",
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
      ...
      <p className="text-text-muted mb-12 max-w-2xl">
        ...
        reach out using the form below or through any of my social links.
      </p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a
                  href="mailto:hello@ankit-shukla.xyz"
                  className="text-text-muted hover:text-accent transition-colors"
                >
                  hello@ankit-shukla.xyz
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-text-muted">Pittsburgh, PA</p>
              </div>
            </div>
